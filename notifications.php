...
page_header('Notifications', $user['role']==='admin' ? 'Create announcements for CHO heads and monitor system events.' : ($user['role']==='office_head' ? 'Read admin announcements and create announcements for your CHO staff.' : 'View announcements from your CHO head and system updates.'), $header);
?>
