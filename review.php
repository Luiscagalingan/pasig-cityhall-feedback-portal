...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'correct') {
            ...
            $scores = compute_feedback_scores($ratings, $label);
            db()->beginTransaction();
