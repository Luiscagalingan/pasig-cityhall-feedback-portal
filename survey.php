...
<div class="survey-shell"><div class="survey-banner"><span class="eyebrow"><?= e($office['code']) ?> PUBLIC FEEDBACK FORM</span><h1><?= e($office['name']) ?></h1><p class="muted survey-intro">Ibahagi ang inyong karanasan sa serbisyong natanggap. Simple lamang ang mga tanong at maaaring sumagot sa Filipino, English, o Taglish. Walang tama o maling sagot.</p><div class="survey-progress" aria-label="Survey sections"><span>1. Tungkol sa pagbisita</span><span>2. Marka sa serbisyo</span><span>3. Komento o mungkahi</span></div></div>
...
<h2 class="section-title">3. Komento o mungkahi / Comment or suggestion</h2><div class="form-group"><label>Ano ang masasabi ninyo sa serbisyong natanggap? <span class="required">*</span></label><textarea name="comment" minlength="5" maxlength="3000" required placeholder="Halimbawa: Maayos ang serbisyo, ngunit sana ay mas maikli ang oras ng paghihintay. Maaari sa Filipino, English, o Taglish."><?= e($_POST['comment'] ?? '') ?></textarea><div class="help">Isulat lamang ang inyong karanasan. Huwag maglagay ng pangalan, numero ng telepono, o sensitibong personal na impormasyon.</div></div>
